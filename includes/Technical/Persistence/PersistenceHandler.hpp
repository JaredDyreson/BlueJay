...
namespace BlueJay::Technical::Persistence {
   ...
   class PersistenceHandler {
     public:
      ...
      findRoles() = 0;  // Returns list of all legal roles
      virtual BlueJay::Technical::Persistence::Credentials findCredentialsByName(
          const std::string&
              name) = 0;  // Returns credentials for specified user, throws
      ...
      // Destructor
      // Pure virtual destructor helps force the class to be abstract, but must
